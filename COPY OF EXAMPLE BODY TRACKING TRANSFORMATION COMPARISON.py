...
if __name__ == "__main__":
	...
	while True:
		...
		for body_id in range(body_frame.get_num_bodies()):
			...
			vector_shoulder_to_elbow_right = -(vector_elbow_to_shoulder_right)
			vector_shoulder_to_clavicle_right = right_clavicle_3d - right_shoulder_3d
			...
			rotation_matrix_right_shoulder = np.array([vector_shoulder_to_clavicle_right,vector_shoulder_to_elbow_right,np.cross(vector_shoulder_to_clavicle_right, vector_shoulder_to_elbow_right)])
        ...
        # Draw the skeletons into the color imageq
		...
		cv2.putText(color_skeleton,f"Angle: {angle_degrees_left_elbow:.2f} degrees", position_left, cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
		cv2.putText(color_skeleton,f"Angle: {angle_degrees_right_elbow:.2f} degrees", position_right, cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
